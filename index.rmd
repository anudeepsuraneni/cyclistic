...
**Goal**: Develop targeted marketing strategies to convert casual riders into annual members. 
**Key Questions:** 
- *How do annual members and casual riders differ in their use of Cyclistic bikes?* 
- What motivates casual riders to consider purchasing an annual membership? 
- How can digital media campaigns encourage casual riders to become members? 
**Business Task:** Analyze Cyclistic's historical bike trip data to identify usage trends and differences between annual members and casual riders. Use these insights to address the other key questions and shape a targeted marketing strategy aimed at increasing annual memberships. 
...
- Created an interactive [Tableau dashboard](https://public.tableau.com/views/CyclisticBike-shareAnalysis_17481008517970/CyclisticBike-shareAnalysis) to visualize the analysis results using the exported summary file.
...
## Next steps
- Currently, 8% of ridership comes from users who depend on assistive options. However, the existing proxy data lacks sufficient detail for a comprehensive analysis of this group. I will seek additional resources to address this gap. 
- Additionally, I will collaborate with the team to create a targeted marketing strategy focused on converting casual riders into annual members.